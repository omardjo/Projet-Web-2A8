...
if (isset($_POST['submit'])) {
	...
	if (isset($_POST['title']) and isset($_POST['description']) and isset($_POST['TypeProjet']) and isset($_POST['competencies']) and isset($_POST['bud/h']) and isset($_POST['country'])) {
		$p = new proposition($_POST['title'], $_POST['description'], $_POST['TypeProjet'], $_POST['competencies'], $_POST['bud/h'], $_POST['country']);
		$pc = new propositionC($p);
		$pc->ajouterProposition($p);
	...
	<div class="container">
		<div class="row my-4">
			<div class="col-md-8 mx-auto">
				<div class="card">
					<div class="card-header">Ajouter un proposition de projet</div>
						...
						<form method="post">
							<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" id="title" class="form-control" name="title" placeholder="Ex:besoin d'aide pour une Présentation PowerPoint" required>
								</div> <!-- .form-group -->
								<div class="form-group">
									<div class="form-group">
										<label for="description">Avec quoi as tu besoin d'aide?</label>
										<textarea id="description" cols="10" name="description" class="form-control" maxlength="10000" required></textarea>
									</div> <!-- .form-group -->

									<div class="form-group">
										<label for="projectType">Type de projet</label>
										<select id="projectType" name="TypeProjet" class="form-control">
											<option value="Select your option">selectionner votre option</option>
									...
									<div class="form-group">
										<label for="budget">Votre budget souhaité(e) pour le Travail de Pigiste</label>
										<select id="budget" name="bud/h" class="form-control">
											<option disabled selected>selectionner votre choix </option>
											<option>10$ ou moins</option>
											<option>10-30$</option>
											<option>au-dessus de 30$</option>
										</select>
									</div>


									<div class="form-group">
										<label for="location"> quel est l'emplacement souhaité(e) de Pigiste? </label>
									...
									<div class="form-group">
										...
										<input type="text" id="competencies" name="competencies" class="form-control" placeholder="Ex:rédaction d'articles et de blogs" required>
									</div>
									<div class="form-group">
